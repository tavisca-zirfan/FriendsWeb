    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.EventType", t => t.EventType, cascadeDelete: true)
                .ForeignKey("dbo.UserCredential", t => t.CreatedBy, cascadeDelete: false)
                .Index(t => t.EventType)
                .Index(t => t.CreatedBy);
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.UserCredential", t => t.Recipient, cascadeDelete: false)
                .Index(t => t.Author)
                .Index(t => t.Recipient);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Post", "Recipient", "dbo.UserCredential");
            ...
            DropForeignKey("dbo.Events", "EventType", "dbo.EventType");
            DropIndex("dbo.UserRoles", new[] { "RoleId" });
            DropIndex("dbo.UserRoles", new[] { "UserId" });
            DropIndex("dbo.UserProfile", new[] { "UserId" });
            DropIndex("dbo.Post", new[] { "Recipient" });
            ...
            DropIndex("dbo.Events", new[] { "EventType" });
