...
namespace DbProviderTest
{
    public class UserGenerator
    {
        ...
        {
            return new User { Email = email, IsActive = 1, Password = password, ChangedPassword = "qwerty", UserId = Guid.NewGuid().ToString(), LastSeen = DateTime.Now, CreatedOn = DateTime.Now };
        }
